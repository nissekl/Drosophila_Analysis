      ...
      if position_x[i+1] == position_x[i] and position_y[i+1] == position_y[i]:
           ...
           if angle_alpha <= angle_beta:
                 if position_y[i+1] >= right_bar_y:
                    angle.append(abs(angle_alpha))
                 else:
                    angle.append(abs(angle_alpha*-1))
           else:
                 if position_y[i+1] >= right_bar_y:
                    angle.append(abs(angle_beta))
                 else:
                    angle.append(abs(angle_beta*-1))
...
#------------Angle Calculate---------------
scoped_angle_ob = angle_calculation_observer_perspective(scoped_coordinate_x, scoped_coordinate_y, lstripex_corrected, lstripey_corrected, rstripex_corrected, rstripey_corrected)
scoped_angle_dro= angle_calculation_drosophila_perspective(scoped_coordinate_x, scoped_coordinate_y, lstripex_corrected, lstripey_corrected, rstripex_corrected, rstripey_corrected)   


if scoped_angle_ob == scoped_angle_dro:
   print 'two data are the same.'
