...
#------------Angle Calculate---------------
angle_dro = angle_calculation(coordinate_x, coordinate_y, lstripex, lstripey, rstripex, rstripey)
angle_ob = angle_calculation_strausssmethod(coordinate_x, coordinate_y, lstripex, lstripey, rstripex, rstripey)

if angle_dro == angle_ob:
