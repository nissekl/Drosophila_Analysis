"""Dorsophila Simulation Analysis Program"""
"""Created by Hung-Hsiu Yen (OSU)"""
...
bardata= sys.argv[2]
calculation_method = int(sys.argv[3]) # 0 means drosophila's perspective method, 1 means observer's prospective
...
#sma = movingaverage(angle,20)<----if you want to draw variation graph, unmark this

#-------------Drawing Graph----------------
#drawing_variation(sma,time,20)<----if you want to draw variation graph, unmark this
